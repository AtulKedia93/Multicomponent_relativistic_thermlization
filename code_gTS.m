%Photon scattering (gamma)(g) with Thomson scattering
...
while i < n
    ...
    dzig=(1+ctheta3.^2).*sqrt(1-ctheta3.^2);    %d(sigma)/d(theta) Thomson scattering
